const nfcChampionshipHistoryMainSection = document.getElementById("nfc-championship-history-main-section")
const nfcChampionshipYearDropdown = document.getElementById("nfc-championship-year-dropdown")
...
nfcChampionshipYearDropdown.addEventListener("change", () => {
        const selectedYear = (nfcChampionshipYearDropdown as HTMLSelectElement).value
        container.innerHTML = ""
...
(nfcChampionshipYearDropdown as HTMLSelectElement).value = defaultYear
