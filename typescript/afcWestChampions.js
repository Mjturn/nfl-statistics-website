var afcWestChampionsMainSection = document.getElementById("afc-west-champions-main-section");
var afcWestChampionsYearDropdown = document.getElementById("afc-west-champions-year-dropdown");
...
afcWestChampionsYearDropdown.addEventListener("change", function () {
    var selectedYear = afcWestChampionsYearDropdown.value;
    container.innerHTML = "";
    switch (selectedYear) {
        case "1960":
...
afcWestChampionsYearDropdown.value = defaultYear;
