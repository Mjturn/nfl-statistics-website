const nfcWestChampionsMainSection = document.getElementById("nfc-west-champions-main-section")
const nfcWestChampionsYearDropdown = document.getElementById("nfc-west-champions-year-dropdown")
...
nfcWestChampionsYearDropdown.addEventListener("change", () => {
        const selectedYear = (nfcWestChampionsYearDropdown as HTMLSelectElement).value
        container.innerHTML = ""
...
(nfcWestChampionsYearDropdown as HTMLSelectElement).value = defaultYear
