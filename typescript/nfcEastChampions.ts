const nfcEastChampionsMainSection = document.getElementById("nfc-east-champions-main-section")
const nfcEastChampionsYearDropdown = document.getElementById("nfc-east-champions-year-dropdown")
...
nfcEastChampionsYearDropdown.addEventListener("change", () => {
        const selectedYear = (nfcEastChampionsYearDropdown as HTMLSelectElement).value
        container.innerHTML = ""
...
(nfcEastChampionsYearDropdown as HTMLSelectElement).value = defaultYear
