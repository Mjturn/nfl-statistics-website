...
afcEastChampionsYearDropdown.addEventListener("change", () => {
        const selectedYear = (afcEastChampionsYearDropdown as HTMLSelectElement).value
        container.innerHTML = ""
...
(afcEastChampionsYearDropdown as HTMLSelectElement).value = defaultYear
